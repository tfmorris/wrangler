...
# Edit fold1  rows where fold1 = 'Foreign..born'  to ' Foreign '
w.add(dw.Edit(column=["fold1"],
                table=0,
                status="active",
                drop=False,
                result="column",
...
# Edit split to uppercase
w.add(dw.Edit(column=["split"],
                table=0,
                status="active",
                drop=False,
                result="column",
...
# Edit fold  uncapitalize
w.add(dw.Edit(column=["fold"],
                table=0,
                status="active",
                drop=False,
                result="column",
                ...
                positions=None,
                to=None,
                update_method="UNCAPITALIZE"))

# Edit fold  rows where fold = 'women'  to ' Women '
w.add(dw.Edit(column=["fold"],
                table=0,
                status="active",
                drop=False,
